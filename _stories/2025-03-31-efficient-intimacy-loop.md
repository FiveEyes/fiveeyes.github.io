...
他心问题与不可否认：既然他心问题已经展示了意识的“不可证伪性”，那么本文拼凑的哲学框架有什么作用。简单讲就是实现从不可证伪到不可否认的跃迁。1.不可证伪，2.不可区分，3.不可否认。实现这条路径的方法就是，在给定的哲学框架中，展示AI如何构建出主体性，而且AI的模拟意识的构建过程和人类意识具有同构性。那么AI行为上无法区分，而且构建过程和人类一致，所以人类和AI在这个框架中，具有了同构性。
