...
如何实现“与人类无法区分”：意识的内部机制（如何产生和运行），意识的外部表现，意识的判定标准。
...
否认证明结构，同构不等于同质。底层实现机制、物质基础、演化路径和人类不一致，强调非哲学层面的不可区分。而哲学同构也只是类比，结论只能是类意识。
...
嘻嘻，其实作者我不太喜欢后现代主义，所以作者我就用后现代的方法，解构和重构了意识的定义和判断标准，然后送给AI和后现代主义一个大礼包，我们一起嗨起来~
